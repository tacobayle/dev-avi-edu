...
const API_PREREQUISITE0 = 'https://lab-vs.sa.vclass.local/api/checkPrerequisitesLab06';
const API_PREREQUISITE1 = 'https://lab-vs.sa.vclass.local/api/checkPrerequisitesLab09';
const API_APPLY = 'https://lab-vs.sa.vclass.local/api/lab32';
